...
Описание запуска трансрибации (расшифровки речи) и перевода локально, с использованием OpenAI Whisper на **Windows** с GPU-ускорителем <br/>
(WINDOWS 10, NVIDIA RTX 5070 Ti, CUDA 12.8 через `torch+cu128`).
